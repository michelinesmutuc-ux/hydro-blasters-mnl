...
export function SiteFooter() {
  return <footer>
    ...
    <div className="footer-links">
      <div><h3>Shop</h3><Link href="/shop">Shop Products</Link><Link href="/compare">Compare Products</Link><Link href="/visit-showroom">Visit Our Showroom</Link><Link href="/appointments">Book a Showroom Visit</Link></div>
