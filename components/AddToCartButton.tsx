...
export function AddToCartButton({ product }: { product: CartProduct }) {
  ...
  function handleClick() { console.log('Add to cart clicked', { productId: product.id, name: product.name, stock: product.stock }); add(product); setMessage('Added to cart'); window.setTimeout(() => setMessage(''), 1800) }
