    ...
    <section className={styles.panel}>
      ...
      {!loading && !error && products.length > 0 && <>
        ...
        return <tr key={product.id}>
          <td>{product.image_urls[0] ? <img className={styles.tableImage} src={product.image_urls[0]} alt="" loading="lazy" decoding="async" /> : <div className={styles.thumbnail}>Image</div>}</td>
          <td>{product.name}</td>
