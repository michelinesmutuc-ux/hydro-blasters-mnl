...
export type CartProduct = { id: string; product_id?: string; name: string; slug: string; category?: string; price: number | string; stock: number; shipping_classification?: 'standard' | 'bulky'; is_clearance?: boolean; image_urls?: string[]; variant_id?: string; variant_group_name?: string | null; variant_name?: string | null }
