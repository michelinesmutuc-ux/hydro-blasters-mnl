    ...
    <section className="section product-detail">
      ...
      <div className="product-detail-grid">
        <div className="product-gallery">
          <ProductImageFrame src={mainImage} alt={product.name} fallbackLabel={`Image unavailable for ${product.name}`} variant="main" eager />
        ...
        <div className="product-detail-copy">
          ...
          {product.is_clearance && <p className="product-clearance-note"><strong>Clearance Sale</strong></p>}
