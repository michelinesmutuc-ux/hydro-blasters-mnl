...
export default function ShippingPolicyPage() {
  return <HelpCenterShell current="/policies/shipping"><p className="eyebrow">Store Policy</p><h1>Shipping Policy</h1>
    ...
    <section><h2>Order processing</h2><ul><li>Orders are processed after the required payment or upfront COD charges have been submitted and verified.</li><li>Payment verification may take up to 24 hours.</li><li>Customers may follow up through the official Facebook account: Hydro Blasters MNL.</li><li>Processing time is separate from courier delivery time.</li></ul></section>
    ...
    <section><h2>Cash on Delivery</h2><p>For COD orders:</p><ul><li>Nationwide shipping and the 1% COD service fee are paid in advance.</li><li>The merchandise amount is paid to the courier upon delivery.</li><li>COD orders are processed only after the required upfront amount is verified.</li></ul><p><Link href="/checkout">Continue to checkout</Link> or <Link href="/help/faq">read the FAQ</Link>.</p></section>
  </HelpCenterShell>
}
