  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header">
        ...
        <nav aria-label="Primary navigation"><a href="/">Home</a><a href="/shop">Shop</a><a href="/about">About</a><a href="/appointments">Book a Visit</a></nav>
        <div className="header-actions"><a className="mobile-shop-link" href="/shop">Shop</a><a className="mobile-about-link" href="/about">About</a><button className="icon-button" type="button" aria-label="Search">⌕</button><CartLink /></div>
      </header>
