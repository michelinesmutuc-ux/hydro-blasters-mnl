...
export default function VisitShowroomPage() {
  return <div className="site-shell">
    ...
    <header className="site-header">
      ...
      <nav aria-label="Primary navigation"><Link href="/">Home</Link><Link href="/shop">Shop</Link><Link href="/about">About</Link><Link href="/visit-showroom">Visit Showroom</Link><Link href="/appointments">Book a Visit</Link></nav>
      <div className="header-actions"><Link className="mobile-shop-link" href="/shop">Shop</Link><Link className="mobile-about-link" href="/about">About</Link><Link className="mobile-visit-link" href="/visit-showroom">Visit</Link><CartLink /></div>
    </header>
