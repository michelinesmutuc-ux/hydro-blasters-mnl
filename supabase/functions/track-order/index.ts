...
const safeOrderFields = 'id,order_reference,customer_name,first_name,last_name,mobile_number,city_municipality,delivery_method,payment_method,merchandise_subtotal,shipping_fee,shipping_tier,cod_service_fee,upfront_amount,rider_collectible_amount,overall_total,promo_name,promo_discount,payment_status,order_status,courier,tracking_number,created_at'
